PARKS = {
    "mtb_parks": {
        ...
        "parks": [
            ...
            {"id": "openspot", "name": "Openspot", "lat": 55.628366, "lon": 37.548082, "dry_hours": 24, "start_date": None, "soil": "podzol", "forest": True, "forest_coef": 0.3, "description": "3 трассы разного уровня, есть трасса для новичков. Дерново-подзолистый грунт на суглинке в парке Битца.", "trails_count": 3},
